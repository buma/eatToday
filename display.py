...
from config import (
        needed_kcal, lunch_kcal, needed_kcal_lunch,
        needed_kcal_2_hours_till_lunch, needed_kcal_2_hours_after_lunch,
        needed_protein, lunch_protein,
        needed_protein_2_hours_till_lunch, needed_protein_2_hours_after_lunch)
